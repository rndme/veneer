//veneer.auto.src.js
//17,300b of code compiled Wednesday, December 03, 2014 12:15:50 AM
...
//veneer requires shim for auto-detecting all needed elements
veneer.requires(document.body.innerHTML.match(/<veneer\-[\w]+/g)
 .filter(function(a,b,c){return c.indexOf(a)==b;})
 .map(function(a){
   return a.slice(8)
 })
.sort(), "http://danml.com/veneer/lib/files/");
