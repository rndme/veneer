//veneer.full.src.js
//85,461b of code compiled Wednesday, October 08, 2014 4:55:19 PM
 ...
 veneer("veneer-loader", {
	events: {
		...
		var elm=e.target;
			...
			var lines=elm.innerHTML.trim().split(/\r?\n/).filter(Boolean).map(function(a){return a.trim();}),
   ...
   veneer("veneer-sort", {
	...
	events: {
		...
		insert: function upd(e){ 
			...
			if(!inp){return console.error("missing contents of sort tag: needs a <select>"); }
