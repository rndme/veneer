//veneer.full.src.js
//104,071b of code compiled Sunday, December 14, 2014 2:25:27 AM
...
insert: function ins(e){
	...
	if(inp.type==="button" || inp.type==="submit"){			
		...
		if(inp[srcProp]==null && dest[0] && dest[0][targKey]!=null){
...
update: function(e){ 
	...
	function attr(o){o.setAttribute(k, val)}	
	function prop(o){o[k]=val}
...
events: {
update: function(e){
	var prop=elm.prop||"value",
	val=elm._inp[prop]||"";
	elm._dest=veneer.$(elm.target);
	elm._dest.forEach(function(a){
		if(a[prop]!=val) a[prop]=typeof val ==="function" ? val.call(a) : val;
	});	
...
insert: function(e){
	...
	elm.append=function(data, blnPre){
		...
		veneer._(t.children).forEach(blnPre===true ? 
...
function changer() {
	...
	sorter = grab(kids[0])-0.789567887 ?  
		function srtNum(a, b) {
