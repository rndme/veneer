//veneer.full.src.js
//103,806b of code compiled Wednesday, December 03, 2014 12:15:48 AM
...
/**  veneer.js custom html tag definition
 {
	...
	version: '1.0.0', tags: 'native date',
	purpose: 'turns a GMT or UTC or ISO Date stamp into a human-friendly counter of the hours+mins (etc etc) since or until. highly customizable with CSS classes and first-word pseudos',
	attribs: { 
...
/**  veneer.js custom html tag definition
 {
	...
	methods: ['render(objData) - updates the html by apply the tags mustache template to the data'],
	events:  [ 'insert', 'update' ]
 } 
**/
...
null!=f&&(d+=g.escape(f));break;case "text":d+=k[1]}return d};g.name="mustache.js";g.version="0.8.1";g.tags=["{{","}}"];var z=new s;g.clearCache=function(){return z.clearCache()};g.parse=function(a,c){return z.parse(a,c)};g.render=function(a,c,b){return z.render(a,c,b)};g.to_html=function(a,c,b,e){a=g.render(a,c,b);if(!v(e))return a;e(a)};g.escape=function(a){return String(a).replace(/[&<>"'\/]/g,function(a){return O[a]})};g.Scanner=u;g.Context=q;g.Writer=s});
 ...
 veneer("veneer-mustache", {
	events: {
		...
		//	try{
				if(elm.object){
					//if(!elm.data) try{ elm._data=eval("0||"+elm.object);}catch(y){}
					if(!elm.data) elm.updateObject();
				}
		//	}catch(y){}
...
//////////////////////////////////////////////
   ...
   veneer("veneer-sparkline", {
	...
	events: {
		update: function upd(e){ 
			var elm=e.target,
			data=(elm.data||"").split(/\s*,\s*/).map(Number).filter(isFinite),
