//veneer.full.src.js
//100,375b of code compiled Saturday, October 25, 2014 2:08:54 AM
...
/**  veneer.js custom html tag definition
 {
	...
	attribs: { value: 'a standard datestamp parse-able by window.Date() to set, or a Date object to get ' },
	events:  [ 'update' ]
 }
**/
...
//////////////////////////////////////////////
 ...
 V("veneer-dateinput", {
	content: "<span class=dtcont><button onclick='parentNode.parentNode.next();return false;'> &lt; </button>"+
			"<input value='{{value}}' type=hidden />"+			
			"<button onclick='parentNode.parentNode.next(1);return false;'> &gt; </button>"+
	...
	events: {
		insert: function(e){
			...
			E.inp.onchange=function(){E.value=this.value;};	
